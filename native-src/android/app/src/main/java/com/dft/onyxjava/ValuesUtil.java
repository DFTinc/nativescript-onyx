...
public class ValuesUtil {
    ...
    // Onyx Setup does not have this swicth
//    public static OnyxConfiguration.FingerDetectMode getFingerDetectMode(Activity a) {
//        if (((CheckBox) a.findViewById(R.id.fingerDetectMode)).isChecked()) {
//            return OnyxConfiguration.FingerDetectMode.DEAD_FINGER;
//        } else {
//            return OnyxConfiguration.FingerDetectMode.LIVE_FINGER;
//        }
//    }
}
