...
export class OnyxClassBase extends Object {
  ...
  public initAndPresentiOSOnyx(
    ...
    errorCallback: OnyxPluginErrorCallback,
    ...
    successCallback: OnyxPluginSuccessCallback): any {

  }

  public initAndPresentAndroidOnyx(
      license: string,
      showOmyxConfig: boolean,
      ...
      onyxSuccessCallback: OnyxPluginSuccessCallback): any {
